...
class ConsultationCreate(ConsultationBase):
    health_worker_id: Optional[UUID] = None # Auto-filled from auth user context
...
class StandardizedConsultationPayload(BaseModel):
    """
    Standardized payload format consumed by future AI Triage and Risk Engine services.
    """
